...
function get20s(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    const num = array[i].years.split(' ');

    if (num[0] >= 1900 && num[2] <= 2000) {
...
console.log('Task 5:', removeArtist(artistsCopy, 0));
...
function addArtist(array) {
  ...
  var item = {
    id: 20,
    name: "Dylan Baker",
    years: "1995 - 11/5/2021",
    genre: "Web Design",
    nationality: "American",
    bio: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean tempus ac tortor id hendrerit.",
  };
  array.push(item);
  return array;
}
